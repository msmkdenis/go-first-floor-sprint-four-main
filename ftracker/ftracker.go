...
func RunningSpentCalories(action int, weight, duration float64) float64 {
	...
	answer := ((runningCaloriesMeanSpeedMultiplier * meanSpeed * runningCaloriesMeanSpeedShift) * weight / mInKm * duration * minInH)
	return answer
}
...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	...
	answer := (walkingCaloriesWeightMultiplier*weight + math.Pow(averageSpeed, 2)/(height/cmInM)*walkingSpeedHeightMultiplier*weight) * duration * minInH
    return answer
}
...
func SwimmingSpentCalories(lenghtPool, countPool int, duration, weight float64) float64 {
    ...
    answer := (averageSpeed + swimmingCaloriesMeanSpeedShift) * swimmingCaloriesWeightMultiplier * weight * duration
    return answer
}
